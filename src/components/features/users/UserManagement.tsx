          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="md:col-span-5">
                <label className={labelClass}>{editingUser ? 'Nova Senha (opcional)' : 'Senha de Acesso'}</label>
                <div className={inputWrapperClass}>
                  <div className={inputIconClass}>
                  ...
                  <input
                    ...
                    className={inputClass}
                    placeholder={editingUser ? "Deixe em branco p/ manter" : "Defina a senha"}
                  ...
                  <div>
                    ...
                    <div className="flex bg-white p-1 rounded-2xl border-2 border-slate-200">
                      <button
                        ...
                        disabled={!isAdmin}
                        className={`flex-1 py-3 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all ${formData.role === 'USER'
                      ...
                      <button
                        ...
                        disabled={!isAdmin}
                        className={`flex-1 py-3 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all ${formData.role === 'ADMIN'
              ...
              return (
                <tr key={user.id} className={`transition-colors group ${!isActive ? 'bg-slate-50/50 opacity-75 grayscale-[0.5]' : 'hover:bg-slate-50'}`}>
                  <td className="px-6 py-4">
                    <span className={`px-3 py-2 rounded-xl font-mono font-bold text-xs border-2 shadow-sm ${!isActive ? 'bg-slate-100 text-slate-400 border-slate-200' : 'bg-white text-slate-800 border-slate-100'
                      }`}>
                      {user.acronym}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold border shadow-sm ${user.role === 'ADMIN'
                  ...
                  <td className="px-6 py-4 flex justify-end gap-2">
                    ...
                    {isAdmin && user.id !== currentUserId && (
                      <button
                        ...
                        className={`transition-colors p-2 rounded-xl ${isActive
